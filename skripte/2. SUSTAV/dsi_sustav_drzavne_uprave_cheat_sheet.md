...
## 3. Akti i unutarnje ustrojstvo

### 3.1. Zakon, uredba i pravilnik
...
Trik pitanja:
- `zakoni`, `uredbe` i `naredbe` nisu provedbeni propisi
...
Ovo se pita kao rubna, ali opasna tema.
...
4. Tko donosi pravilnik o unutarnjem redu ministarstva?  
   `Ministar.`
...
## 12. Rokovi i iznimke koje posebno pitaju
